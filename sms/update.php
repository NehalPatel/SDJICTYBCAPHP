<?php 
    ...
    if(!empty($_POST)){
        ...
        if( !$is_error ){
            ...
            $update_sql = 'UPDATE `students` SET `name` = "'. $student_name .'", `email` = "'. $student_email .'", `gender` = "'. $gender .'", `hobbies` = "'. $hobbies .'", `course` = "'. $course .'", `address` = "'. $address .'",`mobile` = "'. $student_mobile .'",`city` = "'. $student_city .'" WHERE `students`.`id` = '. $student_id;
